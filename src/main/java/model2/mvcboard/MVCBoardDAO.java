...
public class MVCBoardDAO extends DBConnPool {
	...
	// dao는패턴이 똑같고 출력하기 위한.. 등등

	// 생성자에서 DBCP(커네션 풀)를 통해 오라클에 연결한다.
	public MVCBoardDAO() {
		super();
	}
	...
	public int selectCount(Map<String, Object> map) {
		int totalCount = 0;
		/*
		 * 만약 검색어가 있다면 조건에 맞는 게시물을 카운트해야하므로 조건부(where)로 쿼리문을 추가한다.
		 */
	...
	public List<MVCBoardDTO> selectListPage(Map<String, Object> map) {
		...
		try {
			...
			while (rs.next()) {
				...
				dto.setOfile(rs.getNString(6));
				dto.setSfile(rs.getNString(7));
