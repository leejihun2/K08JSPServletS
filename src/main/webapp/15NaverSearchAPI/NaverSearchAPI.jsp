...
$(function() {
	/*
	한 페이지에서 2개 이상의 ajax()함수를 사용해야 할때 공통속성을
	설정하기 위한 용도로 사용된다.
	*/
	$.ajaxSetup({
		url : "../NaverSearchAPI.do", //요청 UTL
		type : "get",				  // HTTP 전송방식
...
function sucFuncJson(d) {
	...
	$.each(d.items, function(index, item) {
		str+="<ul list-style-type: none;>";
		str+="	<li>"+(index + 1)+"</li>";
		str+="	<li>"+item.title+"</li>";
		str+="	<li>"+item.description+"</li>";
		str+="	<li>"+item.bloggenrname+"</li>";
...
<div class="container">
	...
	<div class="row">
		<form id="searchFrm">			
			...
			<input type="text" id="keyword" size="30" value="종각역맛집" class="form-control" />
