...
pageContext.setAttribute("LengtZero", new Integer[0]);
...
<body>
	...
	empty연선자는 true를 반환한다. 즉 객체가 비었는지 확인한다.
	 -->
	<h3>empty 연산자</h3>
	...
	<!-- 
	EL에서는 null이 0으로 판단한다. 따라서 아래의 결과는 10이 나오게된다.
	단, null과 정수를 연산하는 부분을 이클립스는 에러로 표시한다.
	하지만 실행에는 전혀 문제가 없다.
	아래 코드떄문에 프로젝트 전체가 에러가 표시되므로 JSP주석으로 막아 둔다.
	 -->
	<h3>null 연산</h3>
	<%-- 
	null + 10 : ${ null + 10 } <br />
